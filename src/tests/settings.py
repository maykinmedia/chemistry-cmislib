...
#REPOSITORY_URL = 'http://cmis.alfresco.com/alfresco/cmisatom' # Alfresco demo
...
REPOSITORY_URL = 'http://localhost:8080/alfresco/cmisatom' # Alfresco 4.2 CMIS 1.0 Atom
#REPOSITORY_URL = 'http://localhost:8080/alfresco/api/-default-/public/cmis/versions/1.0/atom'
...
TEST_ROOT_PATH = '/'  # No trailing slash
#TEST_ROOT_PATH = '/'
